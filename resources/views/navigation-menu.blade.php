    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('add-gallery') }}" :active="request()->routeIs('add-gallery')">
                        {{ __('Add Gallery Images') }}
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('remove-menu') }}" :active="request()->routeIs('remove-menu')">
                        {{ __('Remove Menu') }}
